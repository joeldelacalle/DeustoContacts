        ...
        <section>
            ...
            <div class="col2" :class="{ 'signup-form': !showLoginForm && !showForgotPassword }">
                ...
                <form v-if="!showLoginForm && !showForgotPassword" @submit.prevent>
                    ...
                    <input v-model.trim="signupForm.name" type="text" placeholder="Eric" id="name" />

                    <label for="telephone">Telefono</label>
                    <input v-model.trim="signupForm.telephone" type="text" placeholder="66666666" id="telephone" />
